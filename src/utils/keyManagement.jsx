...
export const savePrivKey = (privKey, password) => {
...
export const getPrivKey = (password) => {
...
export const getPubKey = (privKey) => {
    ...
    // concat x and y
    const concat_x_y = pubKeyBigInt[0].toString(16) + pubKeyBigInt[1].toString(16).slice(2);
    // hash using keccak256
    return "0x" + keccak256(concat_x_y).slice(-40);
};
export function Generate(pwd) {
    const password = pwd;
    // generate key 
